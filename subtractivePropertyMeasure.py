...
def main():
    ...
    with open('results/subtractiveMeasure001_18.csv', 'w', newline='') as csvfile:
            ...
            while games_found < game_to_find:
                if stability(game_id) >= 0.95:
                    ...
                    if group_found:
                        ...
                        results = [game_id, results_list.count(0), results_list.count(1), results_list.count(2), group,
                                   player_found.number]
                        print(results)
