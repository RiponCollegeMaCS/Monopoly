...
def game_series():
    number_of_games = 100
    print("Playing", number_of_games, "games...")
    results_list = []
    length_list = []
    for i in range(number_of_games):
        player1 = Player(1, [500])
        player2 = Player(2, [500])
        current_game = Game(list_of_players=[player1, player2], auctions=False, free_parking_pool=False,
                            double_on_go=False, no_rent_in_jail=False, trip_to_start=False, snake_eyes_bonus=False)
...
# Card rent for utilities...throw again??? [DONE]