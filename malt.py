...
from random import shuffle, choice, randint  # For random game elements.
...
class Player:
    ...
    def unowned_property_action_archive(self, game_info, property):
    ...
    def unowned_property_action(self, game_info, property):
        property_price = property.price
        # The player has enough money to buy the property.
        if self.money - property_price >= 1:
            if game_info.actions['buying_decisions'].pop(0):
                game_info.buy_property(self, property)
                return True
...
class Game:
    __slots__ = ['auctions_enabled', 'trading_enabled', 'hotel_upgrade', 'building_sellback',
                 ...
                 'first_monopoly', 'record_predicted_winners', 'predicted_winners', 'actions']
    ...
    def add_actions(self, actions):
        ...
        self.community_chest_cards = self.actions['cc_cards']
        self.chance_cards = self.actions['c_cards']
        ...
        if player1.dynamic_ordering:
            ...
            for p2to1 in player2.inventory:
                ...
                if player2.trading_decision(self, property_in=p1to2, property_out=p2to1, other_player=player1):
                    ...
                    # Benefit.
                    benefit = player1.trading_benefit(self, property_in=p2to1, property_out=p1to2, other_player=player2)
                    # print(benefit)
    ...
    def get_roll(self):
        if self.actions['dice_rolls']:
            return self.actions['dice_rolls'].pop(0)
        else:
