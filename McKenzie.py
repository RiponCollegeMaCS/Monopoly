...
def test():
    ...
    #success_rate = success.simple_success_indicator(base_player=grandma, number_of_games=1000)
    success_rate = success.success_indicator(base_player=seasoned_competitor, number_of_games=1000, procs=4)
    print(success_rate)
    #find_n(length=0.01)
...
def generate_confidence_interval():
    ...
    for i in range(50):
        success_rate = success.success_indicator(base_player=newbie, number_of_games=100, procs=1)
        print(success_rate)
    #find_n(length=0.01)
