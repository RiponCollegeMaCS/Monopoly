...
def main():
    ...
    with open('results/with_trades/games_that_do_not_end/weights/weights_all001.csv', 'w', newline='') as csvfile:
        ...
        while run_id < 1:
            ...
            while main_counter < 28:
                ...
                if results['winner'] == 0:
                    ...
                    coefficients = [0 for i in range(40)]

                    for property in results['players'][0].inventory:
                        coefficients[property.id] += 1
