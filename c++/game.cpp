...
void Game::createBoard()
	{
		...
		board[8] = (new BoardLocation(9, "Vermont Ave.", 100, "Light Blue", std::vector<int> {6, 30, 90, 270, 400, 550}, 50));
		board[9] = (new BoardLocation(10, "Connecticut Ave.", 120, "Light Blue", std::vector<int> {8, 40, 100, 300, 450, 600}, 50));
		board[10] = (new BoardLocation(11, "Just Visiting / In Jail"));
		board[11] = (new BoardLocation(12, "St. Charles Place", 140, "Pink", std::vector<int> {10, 50, 150, 450, 625, 750}, 100));
		board[12] = (new BoardLocation(13, "Electric Company", 150, "Utility"));
		board[13] = (new BoardLocation(14, "States Ave.", 140, "Pink", std::vector<int> {10, 50, 150, 450, 625, 750}, 100));
		board[14] = (new BoardLocation(15, "Virginia Ave.", 160, "Pink", std::vector<int> {12, 60, 180, 500, 700, 900}, 100));
		board[15] = (new BoardLocation(16, "Pennsylvania Railroad", 200, "Railroad"));
		board[16] = (new BoardLocation(17, "St. James Place", 180, "Orange", std::vector<int> {14, 70, 200, 550, 750, 950}, 100));
		board[17] = (new BoardLocation(18, "Community Chest"));
		board[18] = (new BoardLocation(19, "Tennessee Ave.", 180, "Orange", std::vector<int> {14, 70, 200, 550, 750, 950}, 100));
		board[19] = (new BoardLocation(20, "New York Ave.", 200, "Orange", std::vector<int> {16, 80, 220, 600, 800, 1000}, 100));
		board[20] = (new BoardLocation(21, "Free Parking"));
		board[21] = (new BoardLocation(22, "Kentucky Ave.", 220, "Red", std::vector<int> {18, 90, 250, 700, 875, 1050}, 150));
		board[22] = (new BoardLocation(23, "Chance"));
		board[23] = (new BoardLocation(24, "Indiana Ave.", 220, "Red", std::vector<int> {18, 90, 250, 700, 875, 1050}, 150));
		board[24] = (new BoardLocation(25, "Illinois Ave.", 240, "Red", std::vector<int> {20, 100, 300, 750, 925, 1100}, 150));
		board[25] = (new BoardLocation(26, "B. & O. Railroad", 200, "Railroad"));
		board[26] = (new BoardLocation(27, "Atlantic Ave.", 260, "Yellow", std::vector<int> {22, 110, 330, 800, 975, 1150}, 150));
		board[27] = (new BoardLocation(28, "Ventnor Ave.", 260, "Yellow", std::vector<int> {22, 110, 330, 800, 975, 1150}, 150));
		board[28] = (new BoardLocation(29, "Water Works", 150, "Utility"));
		board[29] = (new BoardLocation(30, "Marvin Gardens", 280, "Yellow", std::vector<int> {24, 120, 360, 850, 1025, 1200}, 150));
		board[30] = (new BoardLocation(31, "Go to Jail"));
		board[31] = (new BoardLocation(32, "Pacific Ave.", 300, "Green", std::vector<int> {26, 130, 390, 900, 1100, 1275}, 200));
		board[32] = (new BoardLocation(33, "North Carolina Ave.", 300, "Green", std::vector<int> {26, 130, 390, 900, 1100, 1275}, 200));
		board[33] = (new BoardLocation(34, "Community Chest"));
		board[34] = (new BoardLocation(35, "Pennsylvania Ave.", 320, "Green", std::vector<int> {28, 150, 450, 1000, 1200, 1400}, 200));
		board[35] = (new BoardLocation(36, "Short Line Railroad", 200, "Railroad"));
		board[36] = (new BoardLocation(37, "Chance"));
		board[37] = (new BoardLocation(38, "Park Place", 350, "Dark Blue", std::vector<int> {35, 175, 500, 1100, 1300, 1500}, 200));
		board[38] = (new BoardLocation(39, "Luxury Tax"));
		board[39] = (new BoardLocation(40, "Boardwalk", 400, "Dark Blue", std::vector<int> {50, 200, 600, 1400, 1700, 2000}, 200));
...
endReport Game::play()
{
    ...
    int playingOrder[2] = {0, 1}; // TODO: check
