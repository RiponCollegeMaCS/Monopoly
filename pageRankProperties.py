...
def main(games_in_a_set=1000):
    ...
    for prop1 in game0.board:
        for prop2 in game0.board:
            if prop1.is_property and prop2.is_property and prop1 != prop2:
                ...
                matrix[prop1.id][prop2.id] += winners[1]
                matrix[prop2.id][prop1.id] += winners[2]
